  ...
  employeeList.forEach(emp => {
    ...
    rows += `
      <tr class="animate-fade-in">
        ...
        <td>${statusBadge}</td>
        <td>
          <button class="btn btn-primary btn-sm viewProfile" data-id="${emp.id}" title="View Profile"> View</button>
          <button class="btn btn-warning btn-sm toggleStatus" data-id="${emp.id}" title="Toggle Status">Toggle</button>
          <button class="btn btn-danger btn-sm deleteEmployee" data-id="${emp.id}" title="Delete"> Delete</button>
        </td>
      </tr>
    `;
  });
